...
$$
which might be reasonable if we think of a tree as being approximately a cylinder or a cone and assume that expected volume is approximately proportional to the volume of a cylinder or cone (girth is actually diameter). This is a linear model of the form
$$
