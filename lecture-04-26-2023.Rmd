...
```{r}
trtools::contrast(m,
  a = list(Time = 2, treat = c("control","ozone")),
  b = list(Time = 1, treat = c("control","ozone")),
  cnames = c("control","ozone"))
trtools::contrast(m,
  a = list(Time = 2, treat = "control"),
  b = list(Time = 1, treat = "control"),
  u = list(Time = 2, treat = "ozone"),
  v = list(Time = 1, treat = "ozone"))
pairs(emmeans(m, ~Time|treat, at = list(Time = c(2,1)), lmer.df = "asymptotic"))
pairs(pairs(emmeans(m, ~Time|treat, at = list(Time = c(2,1)), lmer.df = "asymptotic")), by = NULL, )
```
