...
```
Suppose we want the rate ratios comparing the epilimnion and thermocline with the hypolimnion layer.
```{r}
contrast(emmeans(m, ~layer, type = "response"), 
  method = "trt.vs.ctrl", ref = 3, type = "response", infer = TRUE, adjust = "none")
```
