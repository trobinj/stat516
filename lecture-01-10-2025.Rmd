...
$$
or $\log_2(1+1/x)$ if $x > 0$. So the change in the expected response if we increase $x$ by one unit *depends on the value of* $x$. The above is also true for any base of logarithm. But for $\log_2$ we have that $\beta_1$ is the change in $E(Y)$ if we *double* $x$. That is,
$$
