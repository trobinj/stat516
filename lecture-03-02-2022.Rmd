...
## Percent Larger/Smaller (Quantitative Explanatory Variable)
...
contrast(m,
    ...
    cnames = c("epil/hypo","therm/hypo"))
contrast(m,
    a = list(layer = c("epilimnion","thermocline")),
    b = list(layer = "hypolimnion"),
    cnames = c("epil/hypo","therm/hypo"), tf = exp)
```
The following gives us inferences for the *logarithm* of the expected count for each layer.t
```{r}
contrast(m, a = list(layer = c("epilimnion","thermocline","hypolimnion")),
...
```{r}
contrast(m, a = list(concentration = c(0, 1, 2), strainf = "a"), 
  cnames = c("0%", "1%", "2%"), tf = exp)
```
