...
0. We can write the Michaelis constant as a *nonlinear* function of the model parameters: $\lambda_h = \lambda_0(1 + h/\kappa)$, where $\lambda_h$ denotes the value of the Michaelis constant when the inhibitor concentration is $h$. Use the delta method to estimate $h_0$, $h_{25}$, and $h_{50}$ (i.e., the values of the Michaelis constant when the inhibitor concentration is 0, 25, and 50 micro moles).
