...
Here I can use `dirname(thisfile())` to find the directory containing this Rmarkdown file, so I do not have to specify the full path to the data file. I have the data stored in a sub-directory ("tickdata") of the directory containing this Rmarkdown file. 
```{r}
ticks <- read.csv("tickdata/tick_data_Robenstein.csv")
...
```{r}
gmu <- read.csv("tickdata/tick_study_areas.csv") |>
