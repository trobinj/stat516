...
In general, the fixed effects approach does not permit proper inferences for explanatory variables that are *nested* within the fixed effect. We are limited to inferences that are *crossed* with the fixed effect.
