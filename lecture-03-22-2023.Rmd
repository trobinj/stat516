...
summary(m)
```
If the model is correct and there is no over-dispersion, the residual deviance has approximate a $\chi^2$ distribution with degrees of freedom equal to its degrees of freedom. We can use this as an informal test for over-dispersion.
```{r}
