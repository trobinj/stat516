...
plot(p)
```
Note that in both cases the *rate of change* of $E(V)$ with respect to one explanatory variable *does not depend on the value of the other variable*. That may or may not be realistic --- more on that later. 
