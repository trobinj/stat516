...
<!-- There's no need to re-estimate and plot each model. Just do it once.  -->
...
For example, if we have a regression model where $E(Y)$ is a function of $X_1$ and $X_2$, a discrete marginal effect of changing $X_1$ from $x_b$ to $x_a$ is 
$$
