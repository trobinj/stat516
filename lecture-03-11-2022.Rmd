...
The **emmeans** package can be used to produce *some* of the inferences that are obtained using `contrast` with respect to estimated expected rates/probabilities as well as rate/odds ratios, but largely with respect to *categorical* explanatory variables (i.e., factors).
...
d <- cbind(d, glmint(m.p, newdata = d))
p <- ggplot(eba1977, aes(x = age, y = cases/pop)) +
